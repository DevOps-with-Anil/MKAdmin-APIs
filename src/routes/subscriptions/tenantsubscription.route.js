...
router.post(
  "/assign-plan",
  checkPermission("TENANT_SUBSCRIPTIONS", "TENANT_ASSIGN_PLAN"),
  tenantSubscriptionController.assignPlan
);
...
router.post(
  "/update-plan",
  checkPermission("TENANT_SUBSCRIPTIONS", "TENANT_UPDATE_PLAN"),
  tenantSubscriptionController.updatePlan
);
...
router.get(
  "/:tenantId",
  checkPermission("TENANT_SUBSCRIPTIONS", "TENANT_VIEW_SUBSCRIPTION"),
  tenantSubscriptionController.getActiveSubscription
);
...
router.post(
  "/cancel",
  checkPermission("TENANT_SUBSCRIPTIONS", "TENANT_CANCEL_SUBSCRIPTION"),
  tenantSubscriptionController.cancelSubscription
);
...
router.get(
  "/history/:tenantId",
  checkPermission("TENANT_SUBSCRIPTIONS", "TENANT_VIEW_SUBSCRIPTION_HISTORY"),
  tenantSubscriptionController.getSubscriptionHistory
);
